...
class Model(nn.Module):
    ...
    def forward(self, x, augment=False, profile=False):
        if augment:
            ...
            print(img_size)
            s = [1, 0.9, 0.95, 1.1, 1.2, 1.17]  # scales
            #f = [None, 2, 3, None, 2, 3]  # flips (2-ud, 3-lr)
            f = [None, 2, 3, 4, 6, None]  # flips (2-ud, 3-lr)
            ...
            for i in range(12):
                ...
                if fi in [4,5,6]:
                    xi = torch_utils.scale_img(x, si)
                    xi = torch.rot90(xi, fi-3, (2, 3))
                yi = self.forward_once(xi)[0]  # forward
                #cv2.imwrite('img'+str(si)+'.jpg' , 255 * xi[0].transpose((1, 2, 0)).cpu().numpy()[:, :, ::-1])  # save
                yi[..., :4] /= si  # de-scale
                if fi == 2:
                    ...
                    yi[..., [2, 3]] = yi[..., [3, 2]] # exchange w, h
                    yi[..., 1], yi[..., 0] = yi[..., 0], img_size[1] - yi[..., 1] # de-rotate           
                elif fi == 5:
                    yi[..., 1], yi[..., 0] = img_size[0] - yi[..., 1],img_size[1] - yi[..., 0],  # de-rotate           
                elif fi == 6:
                    yi[..., [2, 3]] = yi[..., [3, 2]] # exchange w, h
                    yi[..., 0], yi[..., 1] = yi[..., 1], img_size[0] - yi[..., 0] # de-rotate           
                y.append(yi)
